  ...
  `);
    ...
    async function pickOutputFile() {
        ...
        try {
            ...
            lastWriteStatus = `Picker failed: ${e?.name || "Error"}${e?.message ? `: ${e.message}` : ""
                }`;
        }
        renderMain();
    }
        ...
        function renderRows() {
            ...
            rows.forEach((r, idx) => {
                ...
                const line = el(
                    "div",
                    { class: "plcg-kv-grid", style: { marginBottom: "8px" } },
                    [keyInput, valInput, el("div", { style: { textAlign: "right" } }, [delBtn])]
                );
            ...
            el("div", { class: "plcg-field" }, [
                ...
                el("div", {}, [
                    el("div", { class: "plcg-inline" }, [
                        ...
                        el("span", { class: "plcg-muted" }, ["Write a C/C++ block comment header"]),
                    ]),
                ]),
            ])
        );
        ...
        cfgBody.appendChild(
            el("div", { class: "plcg-field" }, [
                ...
                el("div", {}, [
                    ...
                    el("div", { class: "plcg-help" }, [`Saved: ${students.length} entries`]),
                ]),
            ])
        );
